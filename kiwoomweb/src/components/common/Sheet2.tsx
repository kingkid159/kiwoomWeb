 ...
 const [translateY, setTranslateY] = useState(100); 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end">
      <div className="absolute inset-0 bg-gray-400/20 pointer-events-none"></div>
      <div
        ref={sheetRef}
        className="relative w-full max-w-md mx-auto bg-white rounded-t-3xl shadow-xl pb-10 z-30 h-[88vh] overflow-hidden"
